...
public class AddUserDto {
    ...
    public String getWorkedCountry() {
        return workedCountry;
    }
    public void setWorkedCountry(String workedCountry) {
        this.workedCountry = workedCountry;
    }
